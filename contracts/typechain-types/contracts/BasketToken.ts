...
export interface BasketTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "basketManager",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BasketToken extends BaseContract {
  connect(runner?: ContractRunner | null): BasketToken;
  ...
  basketManager: TypedContractMethod<[], [string], "view">;
